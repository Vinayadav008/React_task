...
{/* -------------------Left Area----------------------- */}
            <div className="flex">
              <div className="w-full md:w-1/4 text-center md:text-left">
                ...
                <img src={logo1} alt="logo" className="relative flex py-2 w-24 mt-2" />
                </a>


                {/* paragraph */}
                <p className=" mr-12 pb-6">Dribbble is the world's leading community for creatives to share,
...
{/* -------------------Right Area----------------------- */}
            ...
            <div className="flex my-12">
              <p className=" mr-32 text-gray">
                &copy; 2023 Dribbble. All rights reserved.
              </p>


              {/* Text */}
              <p className=" ml-96 flex mb-9 text-gray">
